...
public class Adactinbase {
	...
	public static WebDriver browser_configuration(String type) {
		...
		if (type.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdrivergecko.driver","C:\\\\Users\\\\PS\\\\eclipse-workspace\\\\Selenium\\\\Driver\\\\gecko.exe");
	...
	public static  void fileutils(String path) throws Exception{
	...
	public static String  getdata(String path,int sheetindex,int rowindex,int cellindex)throws IOException{ 
		...
		public static String getproperties(String path,String Keyvalue) throws IOException {
